        ...
        <div class="game-info">
            ...
            <div class="game-info-body">
                ...
                <div class="game-info-body-right">
                    <h1>Time: ${gameDurationSeconds}</h1>
                </div>
            </div>
        </div>
    </div>
